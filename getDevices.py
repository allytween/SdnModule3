...
#a 'for loop' that will loop through the list and retrieve requested info
...
#updated to 'print prettily!'

#pprint.pprint(devicesJSON)

#tidying up by filtering only what we want!
device = devicesJSON['response'][3]
#pprint.pprint(device)

#creating two variables to hold the device's name and IP address
#then printing this information to the screen

deviceName = device['hostname']
deviceIPv4 = device['managementIpAddress']

print("Device named: " + deviceName + "is at IP: " + deviceIPv4)
"""
